...
// For loop for each piece in response to the event listener that runs the grabPiece() function
for (let piece of pieces) {
  piece.addEventListener("pointerdown", grabPiece);
}
 function grabPiece(e) {
  // Location of the pointer at the beginning
  pointerX = e.clientX;
  pointerY = e.clientY;
  ...
  // Location of the piece at the beginning
  pieceX = e.target.offsetLeft;
  pieceY = e.target.offsetTop;

  // Even listener to drag and drop the pieces
